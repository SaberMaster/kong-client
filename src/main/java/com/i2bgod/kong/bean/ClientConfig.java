...
public class ClientConfig {
    ...
    public ClientConfig(List<String> extraScanPackage) {
        ...
        scanPackages.add(BASE_PACKAGE);
        if (CollectionUtils.isNotEmpty(extraScanPackage)) {
            scanPackages.addAll(extraScanPackage);
        }
        ...
        return extraPluginConfigSet.stream()
                .collect(
                        ...
                        (map, obj) -> {
                            ...
                            map.put(annotation.schemaName(), obj);
                        },
                        Map::putAll
                );
    }
        ...
        return extraPluginConfigSet.stream()
                .collect(
                        ...
                        (map, obj) -> {
                            ...
                            map.put(annotation.dbEntityName(), obj);
                        },
                        Map::putAll
                );
    }
